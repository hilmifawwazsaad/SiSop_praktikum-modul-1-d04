...
directory="/home/hilmifawwaz/sisop/praktikum-modul-1-d04/task-4"

#variabel boolean untuk inisialisasi folder yang dicari
...
#variabel boolean untuk inisialisasi zip yang dicari
zip_ditemukan=false
